import{n,s}from"/dist/chunk-4sh45ybh.js";function e(){return s("div",{class:"markdown-body",children:s(n,{children:[s("h1",{children:"关于低码平台的想法"},void 0,!1,void 0,this),`
`,s("p",{children:"公司内部有一个低码平台。支持是 java + js 的实现的平台。"},void 0,!1,void 0,this),`
`,s("p",{children:`我没有在上面直接开发过东西。毕竟是专业开发，用低码平台效率更差。平台支持用户开发自己的接口。接口只支持 js 实现。我没有看过实现的源码。
...
`,s("p",{children:`ui 开发就比较有意义。平台可以让用户离线完成 ui 部分的开发，然后上传到平台，也支持在平台上直接使用拖拉拽开发。如果使用离线开发模式，就更像是
...
`,s("p",{children:`由此我想到目前的的 serverless 平台。像 aws 的 lambda 或 deno deploy 这样的服务。接口通过简单上手的 js 实现，性能由于 v8 提供保证，安全可以通过 docker 或

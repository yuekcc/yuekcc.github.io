...
关键字：本科、js、nodejs、golang、前端、前端工程化

10年开发经验，主攻 web 应用系统，第一语言 javascript，第二语言 go。
...
### 部门级别 DevOps 系统流水线、依赖软件溯源系统前端

与上面的出口版本不同，这个 DevOps 系统是基于公司级 devops 系统的二次开发。目标是更好地走好最后一公里。这个 DevOps 系统称为 G 系统。
